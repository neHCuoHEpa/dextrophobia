...
public class Create_SteeredWheel_CSEditor : Editor {
	...
	void Set_Inspector () {
		...
		EditorGUILayout.Slider ( Shaft_Collider_RadiusProp , 0.1f , 10.0f , "SphereCollider Radius" ) ;

		// Suspension settings
		EditorGUILayout.Space () ;
		EditorGUILayout.HelpBox( "Suspension settings", MessageType.None, true );
		EditorGUILayout.Slider ( Sus_Vertical_SpringProp , 0.0f , 100000.0f , "Vertical Spring Force" ) ;
		EditorGUILayout.Slider ( Sus_Vertical_DamperProp , 0.0f , 100000.0f , "Vertical Damper Force" ) ;
		EditorGUILayout.Slider ( Sus_Torsion_SpringProp , 0.0f , 100000.0f , "Torsion Spring Force" ) ;
		EditorGUILayout.Slider ( Sus_Torsion_DamperProp , 0.0f , 100000.0f , "Torsion Damper Force" ) ;
		...
		EditorGUILayout.Slider ( Hub_Collider_RadiusProp , 0.1f , 10.0f , "SphereCollider Radius" ) ;
	...
	void Set_ShaftValue () {
		...
		spring.spring = Sus_Vertical_SpringProp.floatValue;
		spring.damper = Sus_Vertical_DamperProp.floatValue;
//		Temp_SoftJointLimit.spring = Sus_Vertical_SpringProp.floatValue ;
//		Temp_SoftJointLimit.damper = Sus_Vertical_DamperProp.floatValue ;
		Temp_Joint.linearLimit = Temp_SoftJointLimit ;
		Temp_SoftJointLimit = Temp_Joint.angularZLimit ; // Set Angular ZLimit
//		Temp_SoftJointLimit.spring = Sus_Torsion_SpringProp.floatValue ;
//		Temp_SoftJointLimit.damper = Sus_Torsion_DamperProp.floatValue ;
