...
public class Create_SteeredWheel_CS : MonoBehaviour {
	...
	public float Sus_Vertical_Spring = 5000.0f ;
	public float Sus_Vertical_Damper = 50.0f ;
	public float Sus_Torsion_Spring = 5000.0f ;
	public float Sus_Torsion_Damper = 50.0f ;
